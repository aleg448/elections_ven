...
register_page(__name__, path="/mapas_mun", name="Inicio", title="Mapas politicos por estado", order=1)
...
layout = html.Div(
    ...
    dbc.Row(
        ...
        html.Iframe(id="map", srcDoc=open(r"data\mapas\Mapa_municipio_2020.html").read(), width="100%", height="600")       
]),
        ],
        align="start",
        justify="between"
